    ...
    public static class Day11Part2
    {
        ...
        public static void Start(string[] args)
        {
            ...
            for (var i = 0; i < inputData.Count; i++)
            {
                ...
                {
                    horizontalLines.Add(inputData[i]);
                    var tempLine = inputData[i].Replace('.', 'N');
                    for (var c = 1; c <= galaxyExpansion; c++)
                    {
                        horizontalLines.Add(tempLine);
                    }                    
                }
            }
            ...
            var columnsAdded = 0;
            var newColumns = "";
            for (var i = 1; i <= galaxyExpansion; i++)
            {
                newColumns += "N";
            }
            ...
            for (var c = 0; c < inputLine.Length; c++)
            {
                ...
                if (!galaxyFound)
                {
                    ...
                    {
                        var expColumns = columnsAdded * galaxyExpansion;
                        horizontalLines[i] = horizontalLines[i].Insert(c + 1 + expColumns, newColumns);
                    }
                    columnsAdded++;
                }
            }
                ...
                using (Graphics g = Graphics.FromImage(bmp))
                {
                    ...
                    for (var c = 0; c < numColumns; c++)
                    {
                        for (var r = 0; r < numRows; r++)
                        {
                            ...
                            if (character == "#")                            
                                g.FillRectangle(Brushes.Red, c * columnWidth, r * rowHeight, columnWidth, rowHeight);
                            
                            if (character == "N")
                                g.FillRectangle(Brushes.Yellow, c * columnWidth, r * rowHeight, columnWidth, rowHeight);
